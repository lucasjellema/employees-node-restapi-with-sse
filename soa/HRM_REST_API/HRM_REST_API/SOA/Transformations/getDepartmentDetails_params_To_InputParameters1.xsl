...
<xsl:stylesheet version="1.0"
                ...
                xmlns:tns="http://xmlns.oracle.com/pcbpel/adapter/db/sp/getDepartmentDetails"
                xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns0="HrmRestAPI_GetDepartmentDetails_response"
                ...
                xmlns:ns2="http://xmlns.oracle.com/pcbpel/adapter/db/HRM_REST_API/HRM_REST_API/getDepartmentDetails"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="WSDL">
        ...
        <oracle-xsl-mapper:rootElement name="getDepartmentDetails_params"
                                       namespace="HrmRestAPI_GetDepartmentDetails_response"/>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [SAT SEP 16 13:04:48 CEST 2017].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:InputParameters>
      <tns:P_ID>
        <xsl:value-of select="/ns0:getDepartmentDetails_params/ns0:departmentId"/>
      </tns:P_ID>
    </tns:InputParameters>
  </xsl:template>
</xsl:stylesheet>
